...
void Gauss_seidel(int n, double **matriz, double *vet, double *x){
...
int main(int argc, char** argv){
  ...
  i++;
    ...
    Gauss_seidel(n, matriz, vet, x);
    igualdade = erro(n, aux, x);
  }
  ...
  saida = fopen("Saidas/Tempo", "a+");
  
  fprintf(saida, "GS: Tempo de %s: %lf\n", argv[1], ((double)tempo)*2/CLOCKS_PER_SEC);
  fprintf(saida, "loopings = %d/%d\n", i, n*6);
